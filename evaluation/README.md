...
|---|---|---|---|---|---|---|---|---|---|---|
| gemma-4-31b-it-new-prompt-01-09 | **0.764** | 0.952 | **0.917** | 0.285 | **0.951** | **1.000** | **1.000** | 1.83 | 0 | 10.8 |
...
## Updates
- 01/09: Updated the prompt to allow rephrasing of the tool query in a more generic way. Seems to have solved the issue on the longsword, now all tests pass. Context recall keeps increasing (good answers, finds the needed text) but context precision is decreasing (a lot of useless data in the retrieved text). Still deciding if it is worth trying to improve it.
